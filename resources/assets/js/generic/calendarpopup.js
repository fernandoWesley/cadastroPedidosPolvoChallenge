...
function calendarpopup() {
	...
	c.monthNames = new Array("Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro");
...
function Calendario(campo,botao)
{
 //campo.disabled = false;
var cal2 = new calendarpopup();
cal2.showYearNavigation();
cal2.select(campo,botao, 'dd/MM/yyyy'); 
 //campo.disabled = true;
return false;
}	
...
function desabilita(campo)
{
  ...
  if ((campo.length > 0) && (campo.length > 10 )){ 
     campo = campo.substr(0,10);
   }
  else if ((campo.length > 0) && (campo.length <11)){
...
function PopupWindow() {
	...
	this.contents = "";
	this.url="";
	this.windowProperties="toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable=no,alwaysRaised,dependent,titlebar=no,fullscrenn=no";
	if (arguments.length>0) {
		this.type="DIV";
